                    ...
                    <div className={classes.cart__items}>
                        {items?.map(item => 
                            <div className={classes.cart__item}  key={item.id+item.price}>
                                <button className={classes.btn__close} onClick={()=>onClickRemove(item)}><IoMdClose size='1.5em'/></button>
                                <div className={classes.cart__item__content}>
                                    <div className={classes.item__image__block}>
                                        <img src={`${serverApi}${item.imgUrl.replace('/uploads', 'uploads/')}`} alt='product_img'/>
                                    </div>
