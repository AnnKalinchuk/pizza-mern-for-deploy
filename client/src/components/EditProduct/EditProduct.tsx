...
import { useUpdateProductMutation, useGetProductByIdQuery } from "../../services/ProductsService";
...
const EditProduct: FC = () => {
    ...
    const {isLoading, data: productById} = useGetProductByIdQuery(id ? id : skipToken);
    ...
    const {register, handleSubmit, formState: { errors, isValid }, reset, control} = useForm<IEditProductFormState>({
          mode:"all",
    ...
    return (
      <div className={classes.form__wrapper}>
        ...
        <input type="submit" disabled={!isValid} value='Update' className={classes.btn_submit}/>
        </div>
        </form>}
        <ToastContainer
                position="top-center"
